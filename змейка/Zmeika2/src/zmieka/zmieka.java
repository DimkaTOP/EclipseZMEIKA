...
class myPanel extends JPanel
{
	...
	public myPanel()
	{
		...
		try 
		{	
			fon = ImageIO.read(new File("C:Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Разработка програмных модулей\\Змейка\\Картинки для игры Змейка\\image101.png"));
			...
			endg = ImageIO.read(new File("Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Разработка програмных модулей\\Змейка\\Картинки для игры Змейка\\endg.png"));
		}
		catch (Exception ex) {}
		myGame = new game();
		myGame.start();
